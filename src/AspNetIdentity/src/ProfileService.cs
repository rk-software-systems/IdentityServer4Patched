    ...
    where TUser : class
{
    ...
    protected virtual async Task<ClaimsPrincipal> GetUserClaimsAsync(TUser user)
    {
        ...
        return principal ?? throw new Exception("ClaimsFactory failed to create a principal");
    }
    ...
    public virtual async Task IsActiveAsync(IsActiveContext context)
    {
        ...
        var sub = (context.Subject?.GetSubjectId()) ?? throw new Exception("No subject Id claim present");

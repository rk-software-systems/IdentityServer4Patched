...
internal class UserClaimsFactory<TUser>(Decorator<IUserClaimsPrincipalFactory<TUser>> inner, UserManager<TUser> userManager) : IUserClaimsPrincipalFactory<TUser>
    where TUser : class
{
    private readonly Decorator<IUserClaimsPrincipalFactory<TUser>> _inner = inner;

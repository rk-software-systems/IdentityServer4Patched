...
public static class IdentityServerBuilderExtensions
{
    ...
    {
        var registration = services.LastOrDefault(x => x.ServiceType == typeof(TService)) ?? throw new InvalidOperationException("Service type: " + typeof(TService).Name + " not registered.");
        ...
        else
        {
            ...
            {
               throw new InvalidOperationException("Invalid registration. ImplementationType is null.");
            }
        }
    }
}
